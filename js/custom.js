jQuery(document).ready(function() {
	...
	// Toggle View
	$('.e-course-section .filter-view #list').click(function(e) {
		e.preventDefault();
		$('.e-course-section').addClass('list-view');
		$('.e-course-section .filter-view a').removeClass('active');
		$(this).addClass('active');
	});
	
	$('.e-course-section .filter-view #grid').click(function(e) {
		e.preventDefault();
		$('.e-course-section').removeClass('list-view');
		$('.e-course-section .filter-view a').removeClass('active');
		$(this).addClass('active');
	});
